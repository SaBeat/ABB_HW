...
class MainViewModel @Inject constructor(
    ...
    private val fileUrl = "https://github.com/SaBeat/ABB_HW" // DON'T FORGET TO SET YOUR URL
        ...
        return downloadFileUseCase(fileUrl)
            .onEach { result ->
                _state.value = when (result) {
                    ...
                    is Resource.Loading -> DownloadingState(isLoading = true,filePercent = result.percent ?: 0.0f)
